...
<head>
  ...
  <title>Cellular Automata Weather Grid</title>
  <style>
    .grid {
      display: grid;
      grid-template-columns: repeat(4, 1fr);
      grid-gap: 2px; /* Adjust gap between cells */
      width: 200px; /* Adjust grid width as needed */
      height: 200px; /* Adjust grid height as needed */
    }
    .cell {
    ...
    .storm {
      ...
      color: #fff; /* White text for storm */
    }
  </style>
</head>
<body>
